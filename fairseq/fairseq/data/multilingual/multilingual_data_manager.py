...
class MultilingualDatasetManager(object):
    def __init__(self, args, lang_pairs, langs, dicts, sampling_method):
        ...
        self.src_langs = args.langs
        self.tgt_langs = args.langs
        self.langs = langs
        self.dicts = dicts
    ...
    def load_all_dictionaries(cls, args, language_list, load_dictionary, training):
        ...
        if args.lang_pairs is not None:
            ...
            src_langs_to_load_dicts = sorted(args.langs)
            tgt_langs_to_load_dicts = sorted(args.langs)
        # else:
