...
@register_model("multilingual_transformer_from_m2m")
class MultilingualTransformerModel(FairseqMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        def get_encoder(lang):
            family_info = lang
            logging.info("current lange is : %s, family information is: %s" % (lang, family_info))
            if lang not in lang_encoders:
                ...
                if hasattr(args, "pretrained_m2m_checkpoint"):
                    ...
                    lang_encoders[family_info] = TransformerEncoderFromPretrainedM2M(args, task.dicts[lang],
        ...
        def get_decoder(lang):
            ...
            if lang not in lang_decoders:
                ...
                if hasattr(args, "pretrained_m2m_checkpoint"):
                    ...
                    lang_decoders[family_info] = TransformerDecoderFromPretrainedM2M(args, task.dicts[lang], decoder_embed_tokens)
                else:
