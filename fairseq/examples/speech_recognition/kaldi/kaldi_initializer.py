...
def create_lexicon(
    ...
    if (
        ...
        lex_disambig_path = (
            Path(cfg.kaldi_root) / "egs/wsj/s5/cm2m_utils/add_lex_disambig.pl"
        )
        res = subprocess.run(
        ...
        disamib_path = Path(cfg.kaldi_root) / "egs/wsj/s5/cm2m_utils/add_disambig.pl"
        res = subprocess.run(
...
def create_L(
    ...
    if not lexicon_graph.exists():
        ...
        make_lex = kaldi_root / "egs/wsj/s5/cm2m_utils/make_lexicon_fst.pl"
